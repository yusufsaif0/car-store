...
<h3><center>Lamborgini Aventador Series Key Specifications</center></h3>
<div class="container">
...
<div class="container">
<h3><center>Lamborgini Aventador Series Mileage</center></h3>
<table id="p1" class="table table-stripd table-hover">
	<tr>
		<th>Fuel Type</th>
		<th>Transmission</th>
...
<h3><center>Upcoming Lamborgini CARS</center></h3>
<div id="content1" style="margin-left: 10px; display:inline-block;">
	<div class="image">
	<img src="image/image1.jpg" height="200px" width="250px;">
	
	<div class="desp" style="font-size: 15px;">Lamborgini 8 Series <br>Dec 2019 <br>₹ 1.25-2 Crore</div>
</div>
	<div class="image">
	<a href="bugatti.php"><img src="image/image41.jpg" height="200px" width="250px;"></a>
	<div class="desp" style="font-size: 15px;">Lamborgini New X6 <br>Feb 2020 <br>  ₹  1.1-16 Crore</div>

	</div>
	<div class="image">
	<a href="rollRoyce.php"><img src="image/image51.jpg" height="200px" width="250px;"></a>
	<div class="desp" style="font-size: 15px;">Lamnorgini i8 Roadster<br>Mar 2020 <br> ₹ 2.8 - 3 Crores</div>
	</div>
	<div class="image">
	<a href="rollRoyce.php"><img src="image/image51.jpg" height="200px" width="250px;"></a>
	<div class="desp" style="font-size: 15px;">Lamborgini i8 Roadster<br>Mar 2020 <br> ₹ 2.8 - 3 Crores</div>
	</div>
	</div>
</div>
<h3 style="margin-left: 120px"><center>Lamborgini 3 SEREIES VIDEO AND IMAGE</center></h3>
